...
def song_cover_pipeline(song_input, voice_model, pitch_change, keep_files,
    ...
    try:
        ...
        ai_vocals_path = os.path.join(song_dir, f'lead ai cover vocal | {voice_model} | {os.path.splitext(os.path.basename(orig_song_path))[0]}.wav')
        ai_backing_path = os.path.join(song_dir, f'backing vocal | {voice_model} | {os.path.splitext(os.path.basename(orig_song_path))[0]}.wav')
