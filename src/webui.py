...
if __name__ == '__main__':
    ...
    with gr.Blocks(theme='otit/violet', title='HRVC-tab 💻') as app:
        ...
        with gr.Tab("Generate"):
            ...
            with gr.Accordion('Voice conversion options', open=False):
                with gr.Row():
                    ...
                    with gr.Column():
                        f0_method = gr.Dropdown(['rmvpe', 'mangio-crepe', 'mangio-crepe-tiny'], value='rmvpe', label='Pitch detection algorithm', info='select F0 optional method')
        ...
        with gr.Accordion('outputs', open=True):
            ...
            with gr.Row():
                vocal_mixed = gr.Audio(label='AI Cover mix vocals', show_share_button=False)
            ...
            generate_btn.click(song_cover_pipeline,
                               inputs=[song_input, rvc_model, pitch, keep_files, is_webui, main_gain, backup_gain,
                                       ...
                                       output_format],
                               outputs=[ai_cover, ai_backing, vocal_mixed])
        ...
        # Download tab
        with gr.Accordion('Download model', open=True):
